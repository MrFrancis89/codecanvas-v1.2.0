...
const FindReplaceManager = (() => {
  ...
  const replaceOne = () => {
    ...
    // A busca usa caseFold:true (case-insensitive), então a comparação
    // também precisa ser case-insensitive para detectar o match atual.
    if (sel && sel.toLowerCase() === query.toLowerCase()) {
